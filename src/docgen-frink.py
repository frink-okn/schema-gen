...
class DocGenerator(Generator):
    ...
    def class_objects_present(self) -> bool:
        try:
            next(self.all_class_objects())
    ...
    def slot_objects_present(self) -> bool:
        try:
            next(self.all_slot_objects())
        except StopIteration:
            return False
        return True
    ...
    def type_objects_present(self) -> bool:
        try:
            next(self.all_type_objects())
        except StopIteration:
            return False
        return True
    ...
    def enum_objects_present(self) -> bool:
        try:
            next(self.all_enum_objects())
        except StopIteration:
            return False
        return True
    ...
    def subset_objects_present(self) -> bool:
        try:
            next(self.all_subset_objects())
        except StopIteration:
            return False
        return True
...
@click.option("--index-name", default="README", show_default=True, help="Name of the index document.")
