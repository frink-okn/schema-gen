...
LinkML schema and documentation generator for the Proto-OKN
...
```
python3 src/docgen-okn.py graph-name.yaml --template-directory src/docgen-okn-templates --directory /path/to/documentation/for/this/graph
```
